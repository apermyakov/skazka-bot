#!/usr/bin/env python3
"""Add revise-flow keys (order_rewriting, order_revised_ok) for 11 locales."""
...
EN_KEYS = {
    "order_rewriting":  "Rewriting with your feedback…",
    "order_revised_ok": "✓ Your feedback was applied — here's the new version",
}
...
async def translate(lang_name):
    ...
    p = (f"Translate to {lang_name}. Warm parental register. Keep ✓ verbatim. Return ONLY JSON.\n"
