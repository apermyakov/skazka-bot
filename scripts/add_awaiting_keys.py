#!/usr/bin/env python3
"""Add awaiting-payment recovery keys (order_pay_again_full, order_awaiting_sub) for 11 locales."""
...
EN_KEYS = {
    "order_pay_again_full": "💜 Pay {price} again",
    "order_awaiting_sub":   "If you didn't complete checkout, the story is still here — review it below and click pay when you're ready.",
}
...
async def translate(lang_name):
    ...
    p = (f"Translate to {lang_name}. Warm parental register. Keep {{price}} verbatim and the 💜 emoji. "
