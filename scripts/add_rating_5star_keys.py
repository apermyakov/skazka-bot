#!/usr/bin/env python3
"""Add 5-star rating widget i18n keys for 11 locales."""
...
EN_KEYS = {
    "order_rate_star":   "star",
    "order_rate_stars":  "stars",
    "order_rate_ph":     "Leave a short comment (optional)",
    "order_rate_ph_bad": "What didn't work? We'll redo it for free or refund.",
    "order_rate_q_bad":  "Sorry it didn't land 😔 Tell us what to fix",
    "order_rate_send":   "Send",
    "order_rate_thanks_bad": "Got it — we'll reach out to you shortly.",
}
...
async def translate(lang_name):
    ...
    p = (f"Translate to {lang_name}. Warm parental register. Keep emoji. "
