...
async def analyze_child_photo(
    ...
    user_text = (
        ...
        "ВАЖНО — НЕ включай ВРЕМЕННЫЕ украшения и разовый праздничный антураж: аквагрим, "
        "рисунки/блёстки на лице, карнавальные маски, короны, мишуру. Это грим с праздника, "
        "а не внешность ребёнка — в сказке его быть не должно. Описывай только постоянные "
        "черты (волосы, глаза, лицо) и обычную одежду.\n\n"
        + topic_block
    )
    payload = {
        "model": vlm_model,
