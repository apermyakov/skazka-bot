...
- Сказка = ~20 сегментов, ~2700 символов, ~3 мин аудио, 4 иллюстрации
- Общее время генерации: ~2.5-4 мин (TTS ~30с, картинки ~60с, видео ~20с)
...
- 4 сцены на сказку, генерируются последовательно (для визуальной консистентности)
